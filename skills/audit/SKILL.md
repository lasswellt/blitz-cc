...
- For the check registry the deterministic lane and the security pillar select from, see [quality.reference.md](/_shared/quality.reference.md)§Shared check registryShared check registry
