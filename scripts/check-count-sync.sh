...
assert_prose README.md 'Skill Catalog \((\d+)\)'          "$C_skills" "Skill Catalog heading"
assert_prose README.md 'Agent Catalog \((\d+)\)'          "$C_agents" "Agent Catalog heading"
assert_prose README.md 'Shared Protocols \((\d+)\)'       "$C_shared" "Shared Protocols heading"
assert_prose README.md 'Hook Reference \((\d+) scripts'    "$C_hook_scripts" "Hook Reference heading (scripts)"
assert_prose README.md '(?<=scripts, )(\d+) events' "$C_events" "Hook Reference heading (events)"
assert_prose README.md 'share (\d+) protocol files'        "$C_shared" "shared protocol prose"
assert_prose hooks/scripts/README.md '^(\d+) scripts in this directory' "$C_hook_scripts" "hooks README script count"
assert_prose hooks/scripts/README.md '\((\d+) wired through' "$C_hook_wired" "hooks README wired count"
assert_prose hooks/scripts/README.md 'across (\d+) hook events' "$C_events" "hooks README event count"
# CLAUDE.md
...
assert_prose CLAUDE.md '(\d+)\s+hook scripts'              "$C_hook_scripts" "hook scripts"
