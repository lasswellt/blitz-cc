...
- Reply contract: `agents/critic.md:205-218` returns `{status, summary≤50w, files_changed, issues, next_blocked_by, verdict}` — field-for-field matches spawn-protocol §9 (`skills/_shared/agent-orchestration.md:539-543`) + token-budget §3 (`skills/_shared/agent-orchestration.md:71,79-83`). `summary` capped "≤50 words" (line 210); token-budget cap is ≤50 words/≤400 chars — honored.
