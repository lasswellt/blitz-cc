...
- Adding or renaming a script changes asserted counts: `scripts/check-count-sync.sh --write`, then reconcile `hooks/scripts/README.md` line 1, `README.md` Hook Reference heading, `CLAUDE.md`, and `.claude-plugin/plugin.json`.
